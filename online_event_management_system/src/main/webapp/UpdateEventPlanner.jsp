...
<head>
    <meta charset="UTF-8">
    <title>Edit Event Planner</title>
...
<div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="bg-white shadow-md p-4 flex justify-between items-center">
            <h2 class="text-lg font-semibold">Update Event Planner</h2>
            <div class="flex items-center space-x-4">
                ...
                <button class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600"
                        onclick="window.location.href='AdminServlet?action=logout';">
                    Logout
                </button>
            </div>
        </header>
        ...
        <main class="flex-1 flex items-center justify-center p-6">
            <div class="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
                <h2 class="text-2xl font-semibold text-gray-700 text-center mb-6">Edit Event Planner Details</h2>
                ...
                <form action="AdminServlet" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="${planner.name}"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="${planner.email}"
                               class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="phone_no" name="phone_no" value="${planner.phone_no}"
                               class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" value="${planner.password}"
                               class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    </div>
