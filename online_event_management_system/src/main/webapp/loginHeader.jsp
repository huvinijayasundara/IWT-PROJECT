  ...
  <nav class="navbar">
    ...
    <div class="nav-section nav-login">
      ...
      <a href="ContactUs.jsp" class="nav-link">Contact Us</a>
       ...
       <form action="customizeEvent.jsp" method="post">
      <a href="customizeEvent.jsp" class="login-btn"  id="cusquote">Custom Quote</a>
      </form>
      
	<form action="getUserEventsServlet" method="post" class="icon-form">
	  <button type="submit" class="pIcon-btn" id="logIn">
	    <img src="images/wed1.jpg" alt="Profile Icon" id="uImage" />
	  </button>
	</form>
    </div>
  </nav>
